...
> :warning: **Правила налоговой команды:** [tdgs-team-rules.md](./tdgs-team-rules.md)
...
**Корпоративные действия (конвертация, сплит):** см. [tdgs-team-rules.md](./tdgs-team-rules.md)
